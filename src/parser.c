...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    [sym_option] = STATE(4),
    [sym_method_option] = STATE(8),
    [sym_url_option] = STATE(8),
    [sym_location_option] = STATE(8),
    [sym_header_option] = STATE(8),
    [sym_data_option] = STATE(8),
    [sym_other_option] = STATE(8),
  ...
  [3] = {
    ...
    [sym_data_option] = STATE(8),
    [sym_other_option] = STATE(8),
    [aux_sym_curl_command_repeat1] = STATE(5),
  ...
  [4] = {
    ...
    [sym_data_option] = STATE(8),
    [sym_other_option] = STATE(8),
    [aux_sym_curl_command_repeat1] = STATE(6),
    [ts_builtin_sym_end] = ACTIONS(35),
    [sym_comment] = ACTIONS(3),
    [anon_sym_curl] = ACTIONS(35),
    [anon_sym_DASH_DASHrequest] = ACTIONS(11),
  ...
  [6] = {
    ...
    [sym_comment] = ACTIONS(3),
    [anon_sym_curl] = ACTIONS(39),
    [anon_sym_DASH_DASHrequest] = ACTIONS(41),
    [anon_sym_DASHX] = ACTIONS(44),
    [anon_sym_DASH_DASHurl] = ACTIONS(47),
    [anon_sym_DASHU] = ACTIONS(50),
    [anon_sym_DASH_DASHlocation] = ACTIONS(53),
    [anon_sym_DASHL] = ACTIONS(56),
    [anon_sym_DASH_DASHheader] = ACTIONS(59),
    [anon_sym_DASHH] = ACTIONS(62),
    [anon_sym_DASH_DASHdata] = ACTIONS(65),
    [anon_sym_DASHd] = ACTIONS(65),
    [anon_sym_DASH_DASHdata_DASHraw] = ACTIONS(68),
    [anon_sym_DASH_DASHdata_DASHascii] = ACTIONS(68),
    [anon_sym_DASH_DASHdata_DASHbinary] = ACTIONS(68),
    [aux_sym_other_option_token1] = ACTIONS(71),
  },
  [7] = {
  ...
  [14] = {
    ...
    [sym_comment] = ACTIONS(3),
    [anon_sym_curl] = ACTIONS(104),
    [anon_sym_DASH_DASHrequest] = ACTIONS(104),
    [anon_sym_DASHX] = ACTIONS(106),
    [anon_sym_DASH_DASHurl] = ACTIONS(104),
    [anon_sym_DASHU] = ACTIONS(106),
    [anon_sym_DASH_DASHlocation] = ACTIONS(104),
    [anon_sym_DASHL] = ACTIONS(106),
    [anon_sym_DASH_DASHheader] = ACTIONS(104),
    [anon_sym_DASHH] = ACTIONS(106),
    [anon_sym_DASH_DASHdata] = ACTIONS(106),
    [anon_sym_DASHd] = ACTIONS(106),
    [anon_sym_DASH_DASHdata_DASHraw] = ACTIONS(104),
    [anon_sym_DASH_DASHdata_DASHascii] = ACTIONS(104),
    [anon_sym_DASH_DASHdata_DASHbinary] = ACTIONS(104),
    [aux_sym_other_option_token1] = ACTIONS(106),
  },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_curl_command, 2, 0, 0),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_curl_command, 3, 0, 0),
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  [44] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  [47] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0), SHIFT_REPEAT(17),
  [50] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0), SHIFT_REPEAT(17),
  [53] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  [56] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [62] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [65] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [71] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_curl_command_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_other_option, 1, 0, 0),
  [76] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_other_option, 1, 0, 0),
  [78] = {.entry = {.count = 1, .reusable = false}}, SHIFT(14),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_option, 1, 0, 0),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_option, 1, 0, 0),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_data_option, 2, 0, 4),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_data_option, 2, 0, 4),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_option, 2, 0, 1),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_method_option, 2, 0, 1),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_url_option, 2, 0, 2),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_url_option, 2, 0, 2),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_location_option, 2, 0, 2),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_location_option, 2, 0, 2),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header_option, 2, 0, 3),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_header_option, 2, 0, 3),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_other_option, 2, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_other_option, 2, 0, 0),
